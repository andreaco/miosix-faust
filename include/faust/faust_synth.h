...
public:
    ...
    void metadata(Meta *m) {
        ...
        m->declare("hoa.lib/copyright",
                   "2012-2013 Guillot, Paris, Colafrancesco, CICM labex art H2H, U. Paris 8, 2019 Wargreen");
    ...
    virtual void compute(int count, FAUSTFLOAT **inputs, FAUSTFLOAT **outputs) {
        ...
        for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
            ...
            float fTemp13 = (fTemp12 +
                             ((fTemp10 - std::floor(fTemp10)) * (ftbl0FaustSynthSIG0[(iTemp11 + 1)] - fTemp12)));
            float fTemp14 = (fRec0[0] * fTemp13);
            float fTemp15 = std::fabs(fTemp14);
            float fTemp16 = (fSlow1 * ((fTemp14 * (fSlow14 + fTemp15)) /
                                       (((FaustSynth_faustpower2_f(fRec0[0]) * FaustSynth_faustpower2_f(fTemp13)) +
                                         (fSlow15 * fTemp15)) + 1.0f)));
